...
class PersegiPanjangPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.asset("assets/persegi panjang.jpg", height: 150),
          Padding(
            padding: EdgeInsets.symmetric(vertical: 16),
            child: Text("Persegi Panjang"),
          ),
          Text(
              "Persegi panjang merupakan bangun datar yang memiliki dua pasang sisi sama panjang dan sejajar serta besar semua sudutnya adalah 90⁰ atau berbentuk siku-siku. Ada berbagai benda yang berbentuk persegi panjang, contohnya pintu, meja, buku tulis, penggaris, kertas, hingga lapangan."),
          Padding(
